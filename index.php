...
<body>
    ...
    <script>
        //check if email already existed in the database using an ajax in the input event
        ...
        // check password using input event if it meets the requirements
        ...
        //check confirm password field if it matches from the password input field using jquery ajax in the input event
        ...
        //hide and show for password and confirm password icon
